...
- Run only ZAP traditional-spider passive baseline behavior. Never enable active scanning, AJAX spidering, authentication, browser automation, arbitrary ZAP arguments, or production targeting.
