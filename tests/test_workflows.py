...
class WorkflowSecurityTests(unittest.TestCase):
    ...
    def test_standard_exit_file_is_written_atomically_and_artifacts_validate_first(self):
        ...
        self.assertIn("needs: [self-scan-minimal, self-scan-standard, scanner-accountability, finding-intelligence-artifacts, security-artifacts, dast-artifacts, api-security-artifacts, authenticated-security-artifacts, fuzzing-artifacts, supply-chain-artifacts]", text)
